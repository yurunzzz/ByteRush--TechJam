...
# NOTE: These three helpers used to live in perform_icbinb_writeup.py. They are
# inlined here so plotting stays self-contained after the paper-writeup modules
# were removed (they are the only pieces plotting actually needed).
